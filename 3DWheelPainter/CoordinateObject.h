...
namespace Object {
	...
	{
	public:
		CoordinateObject() :coordinate_line(), mark_texts(), mark_text_loc_positions(),model(glm::mat4(1.0f)) {}
		CoordinateObject(const LineObject& coordinate_line, const std::vector<MeshObject>&mark_texts,const std::vector<glm::vec3>&mark_text_loc_positions)
