...
namespace Engine {
	...
	void LocalEngine::AddWheelFloatPlant(const QString& floatPlantPath, const Object::MeshObject& floatPlantObj)
	{
	...
	PickMsg LocalEngine::RayPick_Wheel(double xpos, double ypos, glm::mat4 projection, glm::mat4 view, glm::vec3 cameraPosition, int scrWidth, int scrHeight)
	{
		...
		glm::vec3 P1RLoc(Wheel::WheelFlangeTread::STANDARDTREADRADIUS, 0.0f, 0.0f);

		glm::vec3 P2V1Loc(0.0f, 0.0f, Wheel::WheelFlangeTread::STANDARDWIDTH);  //平面2
		glm::vec3 P2V2Loc(1.0f, 0.0f, Wheel::WheelFlangeTread::STANDARDWIDTH);
		glm::vec3 P2V3Loc(0.0f, 1.0f, Wheel::WheelFlangeTread::STANDARDWIDTH);
		glm::vec3 P2RLoc(Wheel::WheelFlangeTread::STANDARDTREADRADIUS, 0.0f, Wheel::WheelFlangeTread::STANDARDWIDTH);
		...
		glm::vec4 TPD = this->GetTreadIntersectPositionAndDisForWheel(ray_dir, cameraPosition, P1V1Wor, P1RWor, objectModel, 0, Wheel::WheelFlangeTread::STANDARDWIDTH);
		...
		else//
		{
			...
			radian = radian < 0 ? (radian + 2 * Wheel::WheelFlangeTread::PIR) : radian;//弧度
