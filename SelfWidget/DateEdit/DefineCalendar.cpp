...
//		<<tr("Jul")<<tr("Aug")<<tr("Sep")<<tr("Oct")<<tr("Nov")<<tr("Dec");
    ...
    pushBtn_YL->setIcon(QPixmap(":/images/al.png"));

	pushBtn_YR->setFixedSize(nO,nO);
	pushBtn_YR->setIconSize(QSize(nI,nI));
    pushBtn_YR->setIcon(QPixmap(":/images/ar.png"));
    ...
    pushBtn_clear->setText(tr("清空"));
    pushBtn_Ok->setText(tr("确定"));
    pushBtn_today->setText(tr("今天"));
