...
void DefDateTimeEdit::getDate( const QDate &date )
{
    this->setDate(date);
}
...
void DefDateTimeEdit::setMyStytle()
{
    ...
    //QDateEdit
    strTemp.append("QDateEdit#CalTimeEdit{ border:1px solid lightgray; color:rgb(0, 159, 149);}");
    strTemp.append("QDateEdit#CalTimeEdit:!enabled{ background:rgb(65, 65, 65); color:rgb(90, 90, 90); border:0px; }");
    strTemp.append("QDateEdit#CalTimeEdit::up-button{  background:rgb(0, 159, 149);width: 16px;  border-width: 1px;}");
    strTemp.append("QDateEdit#CalTimeEdit::up-button:hover{ background:rgb(0, 102, 96); }");
    strTemp.append("QDateEdit#CalTimeEdit::up-button:!enabled{ background:rgb(65, 65, 65); }");
    strTemp.append("QDateEdit#CalTimeEdit::up-arrow{  image:url(:/images/au.png);}");

    strTemp.append("QDateEdit#CalTimeEdit::down-button{  background:rgb(0, 159, 149); width: 16px;  border-width: 1px;}");
    strTemp.append("QDateEdit#CalTimeEdit::down-button:hover{ background:rgb(0, 102, 96); }");
    strTemp.append("QDateEdit#CalTimeEdit::down-button:!enabled{ background:rgb(65, 65, 65); }");
    strTemp.append("QDateEdit#CalTimeEdit::down-arrow{  image:url(:/images/ad.png);}");

	//QDateTimeEdit
	strTemp.append("QDateTimeEdit{border:1px solid gray; height:24px; }");
    strTemp.append("QDateEdit::down-arrow{image:url(:/images/calendar.png);}");
